...
@section('content')
	<ol class="breadcrumb">
		<li class="breadcrumb-item">
			<a href="{{ route('parcels.index') }}">User</a>
		</li>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							{!! Form::open(['route' => 'csv.user.lownload']) !!}

							<!-- Status Field -->
							<div class="form-group col-sm-6">
								{!! Form::label('status', 'Status:') !!}
								{!! Form::select('status', config('const.user.status_list'), null, ['class' => 'form-control','placeholder' => '']) !!}
							</div>
